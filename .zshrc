...
asking
# zstyle ':omz:update' mode reminder  # just remind me to update when 
it's time
...
# Uncomment the following line to disable auto-setting terminal 
title.
...
completion.
# You can also set it to another string to have that shown instead of 
the default red dots.
# e.g. COMPLETION_WAITING_DOTS="%F{yellow}waiting...%f"
# Caution: this setting can cause issues with multiline prompts in 
zsh < 5.7.1 (see #5765)
...
__conda_setup="$('/Users/ogor/miniconda3/bin/conda' 'shell.zsh' 
'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/ogor/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/ogor/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/ogor/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export PATH="/Users/ogor/.deta/bin:$PATH"
...
export PATH="/Users/ogor/.detaspace/bin:$PATH"
...
export EXECUTE_LOCAL_COMMANDS=True
